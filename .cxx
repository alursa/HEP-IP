...
AliAnalysisTaskMyTask::AliAnalysisTaskMyTask() : AliAnalysisTaskSE(), 
  fAOD(0), fOutputList(0), fHistPt(0), fHistPt1(0), fHistPt128(0), fYour2DHistogram(0)
{
...
void AliAnalysisTaskMyTask::UserCreateOutputObjects()
{
    ...
    // 1 histogram
    fHistPt1 = new TH1F("fHistPt1", "fHistPt1", 100, 0, 10);
    fOutputList->Add(fHistPt1);
    PostData(1, fOutputList);


    // 128 histogram
    fHistPt128 = new TH1F("fHistPt128", "fHistPt128", 100, 0, 10);
    fOutputList->Add(fHistPt128);
    PostData(1, fOutputList);


    // 512 histogram
    fHistPt512 = new TH1F("fHistPt512", "fHistPt512", 100, 0, 10);
    fOutputList->Add(fHistPt512);
    PostData(1, fOutputList);

    // 2d pions?
    fYour2DHistogram = new TH1F("fYour2DHistogram", "fYour2DHistogram", 100, 0, 10);
...
void AliAnalysisTaskMyTask::UserExec(Option_t *)
{
    ...
    fAOD = dynamic_cast<AliAODEvent*>(InputEvent());
    if(!fAOD) return;
    Int_t lTracks(fAOD->GetNumberOfTracks());
    for(Int_t l(0); l < kTracks; l++) {
    	AliAODTrack* track = static_cast<AliAODTrack*>(fAOD->GetTrack(l));
